...
chemo_messages: Dict[str, str] = {
    ...
    "a28_southwest": (
        ...
        "PID|1|1000000001^^^^NH|1000001^^^^PAS~1000000001^^^^NH||TEST^TEST^TEST^^Mr.||20000101000000|M|||"
        "^^^^CF11 9AD||01000 000001^PRN^^test@test.com~07000000001^PRS|07000000001^WPN||||||||||||||||||1\r"
        "PD1||||G7000001\r"
        "PV1||U\r"
    ),
    "a31_vel": (
    ...
    "a28_vel": (
        ...
        "PID|1|1000000001^^^^NH|1000000001^^^^NH~V1000001^^^^PAS||TEST^TEST^^^Mrs.||20000101000000|F|||"
        "^^^^CF11 9AD||07000000001^PRN^^test@test.co.uk~07000000001^PRS~"
        "07000000001^PRN^^test@test.co.uk~|07000000001^WPN||||||||||||||||||1\r"
        "PD1||||G7000001\r"
        "PV1||U\r"
    ),
    "a31_southeast": (
        ...
        "1 Street^Town^Rhondda, cynon, taff^^CF11 9AD||07000000001\r"
        "PV1||U\r"
    ),
    "a28_southeast": (
        "MSH|^~\\&|245|245|100|100|20250701123000||ADT^A28|424514032936473|P|2.4|||NE|NE\r"
        "EVN||20250701123000\r"
        "PID|1|1000000001^^^^NH|1000001^^^^PI~1000000001^^^^NH||TEST^TEST||20000101000000|F|||"
        "1^Street^TEST^TEST^CF11 9AD||07000000001\r"
        "PV1||U\r"
    ),
    "a28_bcu": (
        ...
        "1, TEST^TEST^TEST^^CF11 9AD||01000 000001|||||||||||||||||||0\r"
        "PD1||||G0000001\r"
        "PV1||U\r"
    ),
    "a31_bcu": (
        ...
        "TEST,^TEST^TEST TEST^^CF11 9AD||01000 000 001|07000000001||||||||||||||||||0\r"
        "PD1||||G7000021\r"
        "PV1||U\r"
