...
| **hl7-rest** (also tagged **risp-to-mpi**) | risp-hl7-rest-server, core-reference-hl7-transformer, mpi-hl7-sender, mpi-hl7-mock-receiver, sb-emulator | RISP HL7-over-REST ingress to MPI integration flow (WRDS-based PID field translation via core-reference-hl7-transformer, also fans out to WRRS) |
