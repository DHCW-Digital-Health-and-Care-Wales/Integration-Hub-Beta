...
class Settings:
    ...
    max_parallel_queue_fetches: int
...
def get_settings() -> Settings:
    ...
    max_parallel_queue_fetches = int(_read_setting("BUSWATCH_MAX_PARALLEL_QUEUE_FETCHES", "2", config_values))
    if max_parallel_queue_fetches < 1:
        raise ValueError("BUSWATCH_MAX_PARALLEL_QUEUE_FETCHES must be >= 1")
    ...
    return Settings(
        ...
        max_parallel_queue_fetches=max_parallel_queue_fetches,
    )
