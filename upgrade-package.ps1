...
.EXAMPLE
    .\scripts\upgrade-package.ps1 -Package pyjwt -MinVersion 2.13.0

.EXAMPLE
    .\scripts\upgrade-package.ps1 -Package cryptography -MinVersion 44.0.1
#>
...
# Resolve repo root (one level above the scripts/ folder)
