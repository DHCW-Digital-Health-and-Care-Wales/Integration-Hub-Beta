...
class TestGetAckResult(unittest.TestCase):
    ...
    def test_valid_ack_aa(self, mock_logger):
    ...
    @patch('hl7_sender.ack_processor.logger')
    def test_valid_ack_ca(self, mock_logger):
    ...
    @patch('hl7_sender.ack_processor.logger')
    def test_negative_ack_ae(self, mock_logger):
    ...
    @patch('hl7_sender.ack_processor.logger')
    def test_negative_ack_ar(self, mock_logger):
    ...
    @patch('hl7_sender.ack_processor.logger')
    def test_non_ack_message(self, mock_logger):
        non_ack_message = (
    ...
    @patch('hl7_sender.ack_processor.logger')
    def test_malformed_message(self, mock_logger):
