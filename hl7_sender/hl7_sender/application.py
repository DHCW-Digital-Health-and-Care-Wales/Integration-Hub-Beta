    ...
    with (
        ...
        while PROCESSOR_RUNNING:
            receiver_client.receive_messages(MAX_BATCH_SIZE,
                                             lambda message: _process_message(message, hl7_sender_client, audit_client))

def _process_message(message: ServiceBusMessage, hl7_sender_client: HL7SenderClient, audit_client: AuditServiceClient) -> ProcessingResult:
