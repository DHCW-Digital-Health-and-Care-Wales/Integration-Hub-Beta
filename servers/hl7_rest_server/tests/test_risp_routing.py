"""Tests for RispFlowRouter's multi-destination fan-out (plan §3a)."""
...
from tests.helpers import RISP_A28_MESSAGE, RISP_A40_MESSAGE, RISP_ORU_R01_MESSAGE
...
class RispFlowRouterTests(unittest.TestCase):
    ...
    def test_oru_r01_routes_to_wrrs_only_after_schema_validation(self) -> None:
        ...
        with (
            patch("hl7_rest_server.risp_routing.process_er7", return_value=fake_result) as mock_process,
            patch("hl7_rest_server.risp_routing.validate_xml") as mock_validate,
        ):
    ...
    def test_oru_r01_schema_validation_failure_raises(self) -> None:
        ...
        with (
            ...
            patch(
                "hl7_rest_server.risp_routing.validate_xml",
    ...
    def test_oru_r01_unprocessable_message_raises(self) -> None:
        msg = parse_message(RISP_ORU_R01_MESSAGE, find_groups=False)
        with patch(
            "hl7_rest_server.risp_routing.process_er7",
