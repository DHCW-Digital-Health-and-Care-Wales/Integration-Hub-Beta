...
# WEEK2 ADDITION: Import Service Bus components from shared_libs
...
class TrainingHl7ServerApplication:
    ...
    def __init__(self) -> None:
        ...
        # WEEK 2 ADDITION: Service Bus sender client setup
    ...
    def start_server(self) -> None:
        ...
        if self.config.connection_string and self.config.queue_name:
            ...
            connection_config = ConnectionConfig(
                ...
                service_bus_namespace=None, # Not used when connection string is set
            )
            ...
            print("✓ Service Bus sender client initialized")
        else:
            print("-" * 60)
            print("SERVICE BUS INTEGRATION DISABLED (WEEK 2)")
        ...
        message_handler_args = (
            ...
            self.sender_client,  # WEEK 2 ADDITION: Service Bus sender client can be None
        )
    ...
    def stop_server(self) -> None:
        ...
        # =====================================================================
        # WEEK 2 ADDITION: Clean up Service Bus sender client
        # =====================================================================
        if self.sender_client:
            print("Closing Service Bus sender client...")
            self.sender_client.close()
            print("Service Bus sender client closed.")
