...
chemo_messages: Dict[str, str] = {
    ...
    "a28_vel": (
        ...
        "PID|1|1000000001^^^^NH|1000000001^^^^NH~V1000001^^^^PAS||TEST^TEST^^^Mrs.||20000101000000|F|||1 TEST TEST^TEST^^^CF11 9AD||07000000001^PRN^^test@test.co.uk~07000000001^PRS~07000000001^PRN^^test@test.co.uk~|07000000001^WPN||||||||||||||||||1\r"
        "PD1||||G7000001\r"
        "PV1||U\r"
    ),
    "a31_southeast": (
