...
class TestChemocareTransformer(unittest.TestCase):
    def test_transform_a28_southwest_message(self):
        ...
        self.assertEqual(transformed_message.pid.pid_3[1].value, "SWW1000000001^^^192^PI")
        self.assertEqual(transformed_message.pid.pid_5.value, "TEST^TEST^TEST^^Mr.")
        self.assertEqual(transformed_message.pid.pid_31.value, "1")
        self.assertEqual(transformed_message.pid.pid_32.value, "")
    ...
    def test_transform_a31_bcu_message(self):
        ...
        self.assertEqual(transformed_message.msh.msh_11.value, "P")
        self.assertEqual(transformed_message.pid.pid_3[0].value, "1000000001^^^NHS^NH")
        self.assertEqual(transformed_message.pid.pid_3[1].value, "BCUCCC1000000001^^^212^PI")
        self.assertEqual(transformed_message.pid.pid_5.value, "TEST^TEST^T^^Mrs.")
        self.assertEqual(transformed_message.pid.pid_31.value, "0")
        self.assertEqual(transformed_message.pid.pid_32.value, "")
