...
--------------------
See training_hl7v2_receiver/training_hl7v2_receiver/error_handler.py for the production implementation
...
from training_hl7v2_receiver.ack_builder import AckBuilder
from training_hl7v2_receiver.constants import Hl7Constants
...
class ErrorHandler(AbstractErrorHandler):
    ...
    def reply(self) -> str:
        ...
        if isinstance(self.exc, UnsupportedMessageType):
            ...
            print("  To support this type, add it to the handlers dict in training_receiver.py")
        else:
            # -------------------------------------------------------------
