...
def build_common_properties(
    workflow_id: str, msg_sending_app: str | None, flow_name: str | None = None
) -> dict[str, str]:
    return {
        ...
        # Message conversion to XML needs an XSD schema determined by the flow. The flow name is sent to the service bus
        # for the sender to use in generating the correct XML payload for the message store.
        FLOW_NAME_KEY: flow_name if flow_name else "",
    }
