"""
Application Configuration for Training HL7 Verification
======================================================
...
class VerificationConfig:
    ...
    @staticmethod
    def from_env_and_config_file(config_path: str) -> VerificationConfig:
        """
        ...
        Returns:
            A VerificationConfig instance with all settings populated.
