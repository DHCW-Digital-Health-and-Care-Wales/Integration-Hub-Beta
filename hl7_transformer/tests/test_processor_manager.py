...
from hl7_transformer.processor_manager import ProcessorManager
...
class TestProcessorManager(unittest.TestCase):
    ...
    @patch('hl7_transformer.processor_manager.signal.signal')
    ...
    @patch('hl7_transformer.processor_manager.logger')
