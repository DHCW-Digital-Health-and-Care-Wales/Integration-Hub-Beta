...
class TrainingTransformer:
    ...
    def transform_message(self, hl7_msg: Message) -> Message:
        ...
        _ = map_evn(hl7_msg, new_message)  # Transform the EVN segment

        _ = map_pid(hl7_msg, new_message)  # Transform the PID segment
        ...
        def process_message(message: ServiceBusMessage) -> bool:
            ...
            try:
                ...
                try:
                    ...
                    print(transformed_body)  # For training, print the transformed message
                    print(transformed_msg.evn.to_er7())  # For training, print the raw transformed message
                    print(transformed_msg.pid.to_er7())  # For training, print the raw transformed message
