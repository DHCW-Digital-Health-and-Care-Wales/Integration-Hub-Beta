...
def _process_message(
    ...
    try:
        audit_client.log_message_received(message_body, "Message received for PIMS transformation")
        ...
        audit_client.log_message_failed(message_body, error_msg, "PIMS transformation failed")
